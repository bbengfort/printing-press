...
\affil[1]{\textit{pmancini@umd.edu}}
\affil[2]{\textit{\{bengfort,ben\}@cs.umd.edu}}
...
\begin{figure*}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/time_series_new_1.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/select.png}
...
\begin{figure*}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/geography_new_1.png}
