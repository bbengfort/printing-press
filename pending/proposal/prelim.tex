...
5) \bibentry{decandia_dynamo:_2007}

6) \bibentry{lloyd_dont_2011}

7) \bibentry{bailis_potential_2012}
...
1) \bibentry{lamport_paxos_2001}

2) \bibentry{chandra_paxos_2007}

3) \bibentry{lamport_fast_2006}

4) \bibentry{lamport_generalized_2005}

5) \bibentry{moraru_there_2013}

6) \bibentry{biely_s-paxos:_2012}

7) \bibentry{2016arXiv160806696H}

8) \bibentry{ongaro_search_2014}

9) \bibentry{howard_raft_2015}

10) \bibentry{lampson_how_1996}

\subsection{Replication}

1) \bibentry{kubiatowicz_oceanstore:_2000}

2) \bibentry{gray_dangers_1996}

3) \bibentry{karp_randomized_2000}

4) \bibentry{kempe_gossip-based_2003}

5) \bibentry{kraska_mdcc:_2013}

6) \bibentry{li_secure_2004}

7) \bibentry{stoica_chord:_2001}

8) \bibentry{mashtizadeh_replication_2013}

9) \bibentry{keleher1999decentralized}

10) \bibentry{kuenning_automated_1997}
