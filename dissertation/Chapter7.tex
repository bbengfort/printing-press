...
Kraska et al.
\cite{consistency_rationing} initially proposed consistency rationing be on
...
\cite{quasi_linearizability} present quasi-linearizable histories
...
suggested both in Oceanstore \cite{oceanstore} and primary
copy schemes \cite{gray_dangers_1996,vertical_paxos}.
