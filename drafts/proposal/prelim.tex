...
As a result \pjk{no causal relationship between last sentence and next}, ``eventually consistent'' (EC)
...
\pjk{The following seems to assume reader already knows why consensus is worthwhile, even though we've told him that it's not nearly as good for FS as they might have thought.}
