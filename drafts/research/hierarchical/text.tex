...
This paper presents Alia, the first distributed system of its kind to implement
\emph{\hc}, a flexible protocol that enables the tuning and adaptation required
...
and finally, \emph{flexible data placement}, which facilitates a greater proportion
of direct accesses.

Alia is motivated by the need for a simpler and more general-purpose approach to
building large, geographically replicated systems.
