...
In particular, we are concerned about the edge case where all delgates simultaneously
...
a time period significantly longer than it would normaly take to simply elect a new
...
Because events are crticial to the correctness and safety of the system, all events are
