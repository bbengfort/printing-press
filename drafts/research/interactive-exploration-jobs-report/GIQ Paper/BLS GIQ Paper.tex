...
\author{Bor-Chun~Chen,
        Jonggi~Hong,
        Rotem~Katzir and~Peter~Mancini% <-this % stops a space
\thanks{B. Chen: sirius@umd.edu}% <-this % stops a space
\thanks{J. Hong: jonggi.hong@gmail.com}% <-this % stops a space
...
\begin{figure*}[!ht]
    \centering
    \includegraphics[width=1.75\columnwidth]{BensFigures/time_series_new_1.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\columnwidth]{BensFigures/select.png}
...
\begin{figure*}[!ht]
    \centering
    \includegraphics[width=1.75\columnwidth]{BensFigures/geography_new_1.png}
...
\begin{figure*}[!ht]
    \centering
    \includegraphics[width=1.75\columnwidth]{BensFigures/wealth_new_1.png}
