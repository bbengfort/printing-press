...
as to not propagate them back to the eventual cloud or replay them to the
leader.\pjk{huh? this is about followers rejecting already seen writes. Could
  deal with eventual going around raft. P\_local being higher than .5 tends to
  prevents eventual from going around raft.}
