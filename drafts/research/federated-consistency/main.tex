...
The system then compares version recency is determined by comparing the forte
...
otherwise the increment of a write's forte number results in a timestamp later
than that of writes derived it.
...
models in one system, they still expect a homogenous consistency model that
