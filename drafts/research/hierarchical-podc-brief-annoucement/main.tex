...
\section{Correctness}
\vspace{-.5em}
\pjk{Go ahead if you want to take another stab at this, or add text back where
  I've hacked too much. Otherwise I'll remove
  it and undo some of the hacks I've used to save space.}
